...
In each of the two simulations the throughput per user was calculated. The difference between the two cases is quite large, as presented in table \ref{tab:tp}. 
